                    ...
                    <ul class="header__contact">
                        ...
                        <li>
                            <span class="overhead">Telefone</span><a
                                href="https://api.whatsapp.com/send?phone=55DDD9.0000-0000">+55 (xx) xxxxx-xxxx </a>
                        </li>
                    </ul>
                    <ul class="header__contact">
                            ...
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    ...
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Aprendiz de Desenvolvedor WEB</h5>
                                        <span class="timeline__period">2020 — 2020</span>
                                        <p class="timeline__description">
                                            Instituto Federal - Araguaina - TO</p>
                                    </article>
                                    ...
                                    <article class="timeline__item">
                                        ...
                                        <span class="timeline__period">0000 — 0000</span>
